...
export const evKeyZ = 18;
export const evKeyX = 19;
...
eventArray[evKeyZ] = false;
eventArray[evKeyX] = false;
...
export const evKeyZ_p = 15;
export const evKeyX_p = 16;
...
eventArray_p[evKeyZ_p] = false;
eventArray_p[evKeyX_p] = false;
...
export function LPEventsInit(_window) {
    ...
    _window.addEventListener('keydown', function (event) {
        ...
        if (keyCode == 'KeyR') {
            if (isUnitTest()) console.log(`JS: Keydown KeyR`);
            fireEvent(evKeyR);
            firePEvent(evKeyR_p);
        }
        if (keyCode == 'KeyF') {
            if (isUnitTest()) console.log(`JS: Keydown KeyF`);
            fireEvent(evKeyF);
            firePEvent(evKeyF_p);
        }
        if (keyCode == 'KeyT') {
        ...
        if (keyCode == 'KeyZ') {
            if (isUnitTest()) console.log(`JS: Keydown KeyZ`);
            fireEvent(evKeyZ);
            firePEvent(evKeyZ_p);
        }
        if (keyCode == 'KeyX') {
            if (isUnitTest()) console.log(`JS: Keydown KeyX`);
            fireEvent(evKeyX);
            firePEvent(evKeyX_p);
        }
    });
    ...
    _window.addEventListener('keyup', function (event) {
        ...
        if (keyCode == 'KeyR') {
            if (isUnitTest()) console.log(`JS: Keyup KeyR`);
            turnOffPEvent(evKeyR_p);
        }
        if (keyCode == 'KeyF') {
        ...
        if (keyCode == 'KeyZ') {
            if (isUnitTest()) console.log(`JS: Keyup KeyZ`);
            turnOffPEvent(evKeyZ_p);
        }
        if (keyCode == 'KeyX') {
            if (isUnitTest()) console.log(`JS: Keyup KeyX`);
            turnOffPEvent(evKeyX_p);
        }
